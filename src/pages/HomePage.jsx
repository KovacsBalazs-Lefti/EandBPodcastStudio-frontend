        ...
        <div className="container">
            <div className="align-items-center">
                <div className="container">
                    ...
                    <p>A podcaststúdiónk egy ízlésesen berendezett jóhangulaú, helyszín, amely tökeletes áthangolódást biztosít mind az előadó, mind a beszélgetőpartner számára. <br />
                        A stúdió helyszínhez egy alapszolgáltatási csomag kapcsolódik, amely kiegészíthető választható extra szolgáltatásokkal. A stúdió bérlése
                        8000 Ft+Áfa/óra. HANG- és képi RÖGZÍTÉS, két mikrofonnal, 2 db kamerával rögzítjük. A kész hang- és képanyagot vágatlanul
                        átatdjuk a megrendelőnek, az általa hozott adathordozón. A szolgáltatást 2 db bp40-es podcast mikrofon valamint egy RODE Rodecaster PRO podcast keverőpult biztosítja.
                    </p>
